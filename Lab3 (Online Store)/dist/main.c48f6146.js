...
var carts = document.querySelectorAll('.add_cart'); // The list of Our Sneakers is:
...
var _loop = function _loop(q) {
  carts[q].addEventListener('click', function () {
    cartNumbers(products[q]); // console.log("added to the cart when we clicked it");
...
function setItems(product) {
  ...
  var cartItems = localStorage.getItem("productsInCart"); // now we can pass JSON into a JS object

  cartItems = JSON.parse(cartItems); // console.log("My  artItems are", cartItems);
...
function totalCost(product) {
  ...
  var cartCost = localStorage.getItem("totalCost"); // cartCost = parseInt(cartCost);
